...
public class VolunteerNeerRequestsAdapter extends ArrayAdapter<JSONObject> {
    ...
    public VolunteerNeerRequestsAdapter(Context context, int resource, List<JSONObject> heroList) {
